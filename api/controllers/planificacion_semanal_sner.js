...
function savePublication(req, res) {
    ...
    if (!params.descripcion && !params.title && !params.price && !params.image) return res.status(200).send({ message: 'debes enviar la actividad' });

    var publication = Publication();

    publication.descripcion = params.descripcion;
